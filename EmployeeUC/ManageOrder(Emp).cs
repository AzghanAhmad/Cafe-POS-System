...
{
    public partial class ManageOrder_Emp_ : UserControl
    {
        DataTable orderItemsTable = new DataTable();
        public ManageOrder_Emp_()
        {
            InitializeComponent();
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    using (SqlDataAdapter adapter = new SqlDataAdapter(query, connection))
                    {
                        ...
                        UserDataGrid_OrderitemsData.DataSource = orderItemsTable;
                    }
                }
            }
            catch (Exception ex)
        ...
        private void ViewpendingOrders_Click(object sender, EventArgs e)
        {
            string connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=CMS;Integrated Security=True;Encrypt=false";
            string query = @"select o.OrderID, c.Name as CustomerName, o.Date, o.Status from Orderr o join Customer c on o.CustomerID = c.CustomerID where o.Status = 'Pending'";
        ...
        private void ViewProcessingOrder_button_Click(object sender, EventArgs e)
        {
            string connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=CMS;Integrated Security=True;Encrypt=false";
            string query = @"select o.OrderID, c.Name AS CustomerName, e.Name AS EmployeeName, o.Date, o.Status from Orderr o join Customer c on o.CustomerID = c.CustomerID join Employee e on o.EmployeeID = e.EmployeeID where o.Status = 'Processing'";
        ...
        private void button_totalpendingorders_Click(object sender, EventArgs e)
        {

            string connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=CMS;Integrated Security=True;Encrypt=false";
            string query = @"select Status, COUNT(OrderID) as TotalOrders from Orderr group by Status having Status = 'Pending'";
